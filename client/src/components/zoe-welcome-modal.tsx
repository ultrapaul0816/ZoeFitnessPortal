...
export default function ZoeWelcomeModal({
  isOpen,
  onClose,
  userId,
  ...
  return (
    <Dialog
      open={isOpen}
      onOpenChange={(open) => !open && hasConsented && handleClose()}
    >
      <DialogContent className="max-w-[95vw] sm:max-w-3xl max-h-[95vh] overflow-hidden p-0 bg-white border border-gray-200/50 shadow-2xl [&>button]:hidden">
        ...
        <div className="overflow-y-auto max-h-[95vh] bg-white">
          ...
          <div className="px-6 pt-8 pb-6 text-center bg-white border-b border-gray-100">
            <img
              src="/attached-assets/Screenshot 2025-09-20 at 21.18.10_1758383297530.png"
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-sm leading-relaxed text-gray-700">
                      "Stronger with Zoe – Postnatal Health & Fitness Bible" is
                      designed to provide general information and support for
                      postpartum women on their recovery, health, and fitness
                      journey. The information and exercises provided are for
                      educational purposes only and are not intended to replace
                      professional medical advice, diagnosis, or treatment from
                      a qualified healthcare provider. Always consult with your
                      physician, physiotherapist, or other qualified health
                      provider regarding any medical condition, postpartum
                      recovery concerns, or exercise regimen.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="group relative bg-white border border-gray-200 rounded-2xl p-5 shadow-sm hover:shadow-md transition-all duration-300 hover:border-pink-300/70">
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-sm leading-relaxed text-gray-700">
                      Participation in any postnatal exercise program carries
                      inherent risks, particularly following childbirth. It is
                      the responsibility of each participant to consult with a
                      healthcare provider before beginning this or any other
                      exercise program. By using "Stronger with Zoe – Postnatal
                      Health & Fitness Bible", you acknowledge that you have
                      been cleared by your healthcare provider to engage in
                      postpartum physical activities. You voluntarily assume all
                      risks associated with participation and accept full
                      responsibility for any potential injury, discomfort, or
              ...
              <div className="group relative bg-white border border-gray-200 rounded-2xl p-5 shadow-sm hover:shadow-md transition-all duration-300 hover:border-pink-300/70">
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-sm leading-relaxed text-gray-700">
                      Zoe Modgill and "Stronger with Zoe" shall not be liable
                      for any claims, demands, injuries, damages, actions, or
                      cause of action that arise in connection with, or as a
                      result of, the postnatal program, workouts, or any
                      recommendations provided therein. Participants agree to
                      release and hold harmless Zoe Modgill and any affiliated
                      entities from and against any claims arising from their
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-sm leading-relaxed text-gray-700">
                      ...
                      information presented in this guide, "Stronger with Zoe"
                      cannot guarantee that all information is up-to-date,
                      accurate, or complete at all times. Health and fitness
                      recommendations evolve, and individual needs may vary. Any
                      reliance you place on the information in this guide is
              ...
              <div className="group relative bg-white border border-gray-200 rounded-2xl p-5 shadow-sm hover:shadow-md transition-all duration-300 hover:border-pink-300/70">
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-sm leading-relaxed text-gray-700">
                      Your privacy is of utmost importance. Any personal
                      information you choose to share within "Stronger with Zoe"
                      communities, coaching sessions, or discussions will be
                      treated with confidentiality and will not be disclosed to
                      any third party without your explicit consent, except as
                      required by law.
                    </p>
                  </div>
                </div>
              ...
              <div className="bg-gray-50 border border-gray-200 rounded-2xl p-5">
                <div className="flex items-start space-x-4">
                  ...
                  >
                    ...
                    I confirm that I have received medical clearance from my
                    healthcare provider to begin exercising. I understand the
                    risks involved and agree to use my own judgment while
                    participating in this program. I will stop any exercise that
                    causes discomfort or pain and consult my healthcare provider
                    as needed.
                  </label>
                </div>
              </div>
