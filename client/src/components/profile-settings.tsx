...
import { ChevronDown, Info, Globe, BookOpen, User, LogOut, ChevronRight, ArrowRight, ArrowLeft, Mail, HelpCircle, Copy } from "lucide-react";
...
export default function ProfileSettings({ isOpen, onClose, user, onUserUpdate }: ProfileSettingsProps) {
  ...
  const [currentView, setCurrentView] = useState<'menu' | 'profile' | 'support'>('menu');
