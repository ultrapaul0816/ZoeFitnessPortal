...
export default function ProfileSettings({ isOpen, onClose, user, onUserUpdate, initialView = 'menu', onShowOnboarding }: ProfileSettingsProps) {
      ...
      >
        <div className="w-full h-full overflow-y-auto p-6">
          ...
          <div className="bg-white rounded-lg p-8 shadow-sm text-center">
            ...
            {(() => {
              const now = new Date();
              const expiryDate = user.whatsAppSupportExpiryDate ? new Date(user.whatsAppSupportExpiryDate) : null;
              const isActive = user.hasWhatsAppSupport && expiryDate && expiryDate > now;
              ...
              return (
                <div className={`rounded-lg p-6 mb-6 border ${
                  ...
                  isExpired ? 'bg-gradient-to-r from-amber-50 to-orange-50 border-amber-200' :
                  'bg-gradient-to-r from-green-50 to-emerald-50 border-green-200'
                }`}>
                  <div className="flex items-center justify-center mb-4">
                    <svg className={`w-6 h-6 mr-2 ${isExpired ? 'text-amber-600' : 'text-green-600'}`} fill="currentColor" viewBox="0 0 24 24">
                  ...
                  <div className="bg-white rounded-lg p-4 shadow-sm">
                    <div className="text-center">
                      {isActive && !isExpiringSoon && (
                        <>
                          <div className="inline-flex items-center gap-1.5 px-3 py-1 bg-green-100 text-green-700 rounded-full text-sm font-medium mb-3">
                            <span className="w-2 h-2 bg-green-500 rounded-full"></span>
                            Active
                          </div>
                          <p className="text-base font-medium text-gray-900 mb-1">You're in the community!</p>
                          <p className="text-sm text-gray-500">Expires on {formattedExpiry}</p>
                        </>
                      )}
                      ...
                      {isActive && isExpiringSoon && (
                        <>
                          ...
                          <p className="text-base font-medium text-gray-900 mb-1">Your access expires in {daysRemaining} day{daysRemaining === 1 ? '' : 's'}</p>
                          <p className="text-sm text-gray-500 mb-4">Renew to keep your spot in the community</p>
                          <Button 
                            onClick={() => window.open('https://rzp.io/rzp/SiWM4aC', '_blank')}
                            className="bg-amber-500 hover:bg-amber-600 text-white font-medium px-6 py-2 rounded-full shadow-md hover:shadow-lg transition-all duration-200 flex items-center mx-auto"
                      ...
                      {isExpired && (
                        <>
                          <div className="inline-flex items-center gap-1.5 px-3 py-1 bg-red-100 text-red-700 rounded-full text-sm font-medium mb-3">
                            <span className="w-2 h-2 bg-red-500 rounded-full"></span>
                            Expired
                          </div>
                          <p className="text-base font-medium text-gray-900 mb-1">Your access expired on {formattedExpiry}</p>
                          <p className="text-sm text-gray-500 mb-4">Renew to rejoin the WhatsApp group and get Coach Zoe's support again</p>
                          <Button 
                            onClick={() => window.open('https://rzp.io/rzp/SiWM4aC', '_blank')}
  ...
  if (currentView === 'profile') {
    return (
      ...
      >
          ...
          <div className="bg-white rounded-lg p-6 mb-6 shadow-sm">
            ...
            <div className="space-y-2">
              ...
              <button 
                ...
                className="w-full flex items-center justify-between p-3 rounded-lg border border-gray-200 hover:border-pink-300 hover:bg-pink-50 transition-all duration-200 group"
              >
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-gray-700 group-hover:text-pink-600 font-medium">Change password</span>
                </div>
                <ArrowRight className="w-4 h-4 text-gray-400 group-hover:text-pink-500 group-hover:translate-x-1 transition-all duration-200" />
              </button>
            </div>
          </div>
        ...
        {/* Password Change Dialog for Profile View */}
            ...
            <div className="flex flex-col space-y-1">
              ...
              <button 
                ...
                onClick={(e) => {
                  e.stopPropagation();
                  onClose();
                  setLocation("/my-progress-photos");
                }}
