        ...
        <div className="pl-2 pr-6 pt-6 pb-6">
          <div className="flex flex-col space-y-3">
            ...
            <div className="flex justify-start">
              ...
              >
                {/* Cascading pink gradient overlay */}
                <div 
                  className="absolute inset-0 bg-gradient-to-r from-pink-50 to-rose-50 shadow-lg shadow-pink-200/50 border border-pink-300 rounded-2xl transition-transform duration-300 origin-top will-change-transform"
                  style={{ 
                    transform: (isOpen && !isClosing) ? 'scaleY(1)' : 'scaleY(0)',
                    transitionDelay: isClosing ? '240ms' : '0ms'
                  }}
                ></div>
            ...
            <div className="flex justify-start">
              ...
              >
                ...
                <div 
                  ...
                  style={{ 
                    transform: (isOpen && !isClosing) ? 'scaleY(1)' : 'scaleY(0)',
                    transitionDelay: isClosing ? '160ms' : '80ms'
                  }}
                ></div>
                <div className="absolute inset-0 bg-gradient-to-r from-pink-400 to-rose-400 opacity-0 group-hover:opacity-10 group-hover:animate-in group-hover:slide-in-from-top-2 transition-all duration-300 rounded-2xl"></div>
                <div className="w-8 h-8 bg-gradient-to-r from-rose-400 to-pink-500 rounded-full flex items-center justify-center group-hover:scale-110 group-hover:rotate-12 transition-all duration-500 group-hover:shadow-xl group-hover:shadow-pink-300 relative z-10">
            ...
            <div className="flex justify-start">
              ...
              >
                ...
                <div 
                  ...
                  style={{ 
                    transform: (isOpen && !isClosing) ? 'scaleY(1)' : 'scaleY(0)',
                    transitionDelay: isClosing ? '80ms' : '160ms'
                  }}
                ></div>
                <div className="absolute inset-0 bg-gradient-to-r from-pink-400 to-rose-400 opacity-0 group-hover:opacity-10 group-hover:animate-in group-hover:slide-in-from-top-2 transition-all duration-300 rounded-2xl"></div>
                <div className="w-8 h-8 bg-gradient-to-r from-rose-400 to-pink-500 rounded-full flex items-center justify-center group-hover:scale-110 group-hover:rotate-12 transition-all duration-500 group-hover:shadow-xl group-hover:shadow-pink-300 relative z-10">
            ...
            <div className="flex justify-start">
              ...
              >
                ...
                <div 
                  ...
                  style={{ 
                    transform: (isOpen && !isClosing) ? 'scaleY(1)' : 'scaleY(0)',
                    transitionDelay: isClosing ? '0ms' : '240ms'
                  }}
                ></div>
                <div className="absolute inset-0 bg-gradient-to-r from-pink-400 to-rose-400 opacity-0 group-hover:opacity-10 group-hover:animate-in group-hover:slide-in-from-top-2 transition-all duration-300 rounded-2xl"></div>
                <div className="w-8 h-8 bg-gradient-to-r from-rose-400 to-pink-500 rounded-full flex items-center justify-center group-hover:scale-110 group-hover:rotate-12 transition-all duration-500 group-hover:shadow-xl group-hover:shadow-pink-300 relative z-10">
            ...
            <div className="flex justify-start">
              ...
              >
                ...
                <div 
                  ...
                  style={{ 
                    transform: (isOpen && !isClosing) ? 'scaleY(1)' : 'scaleY(0)',
                    transitionDelay: isClosing ? '0ms' : '320ms'
                  }}
                ></div>
                <div className="absolute inset-0 bg-gradient-to-r from-pink-400 to-rose-400 opacity-0 group-hover:opacity-10 group-hover:animate-in group-hover:slide-in-from-top-2 transition-all duration-300 rounded-2xl"></div>
                <div className="w-8 h-8 bg-gradient-to-r from-rose-400 to-pink-500 rounded-full flex items-center justify-center group-hover:scale-110 group-hover:rotate-12 transition-all duration-500 group-hover:shadow-xl group-hover:shadow-pink-300 relative z-10">
