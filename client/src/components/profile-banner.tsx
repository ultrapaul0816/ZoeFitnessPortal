...
export default function ProfileBanner({ 
  ...
  return (
    <div className={`relative bg-gradient-to-r from-pink-50 to-rose-50 border border-pink-200 rounded-lg p-4 shadow-sm ${className}`}>
      {/* Dismiss Button */}
      <button
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="flex items-center space-x-3">
            <Button
              ...
              size="sm"
              className="bg-gradient-to-r from-pink-500 to-rose-500 hover:from-pink-600 hover:to-rose-600 text-white font-medium px-4 py-2 rounded-full shadow-md hover:shadow-lg transition-all duration-200"
            >
            ...
            <Button
              ...
              variant="ghost"
              size="sm"
              className="text-gray-600 hover:text-gray-800 font-medium px-3 py-2 rounded-full hover:bg-gray-100 transition-all duration-200"
            >
