...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Close
    ref={ref}
    className={cn(
      "absolute right-1 top-1 rounded-md p-2 text-foreground/70 opacity-100 transition-all hover:text-foreground hover:bg-black/5 focus:opacity-100 focus:outline-none focus:ring-2 active:scale-95 min-w-[44px] min-h-[44px] flex items-center justify-center group-[.destructive]:text-red-400 group-[.destructive]:hover:text-red-50 group-[.destructive]:hover:bg-red-900/20 group-[.destructive]:focus:ring-red-400 group-[.destructive]:focus:ring-offset-red-600",
      className
    )}
    toast-close=""
    {...props}
