      ...
      <div className="max-w-6xl mx-auto px-4 md:px-6 py-4 md:py-6 space-y-4 md:space-y-6">
        ...
        <Tabs defaultValue="welcome" className="space-y-6">
          <div className="overflow-x-auto px-0">
            <TabsList className="flex w-full md:grid md:grid-cols-7 gap-2 md:gap-4 h-auto p-3 md:p-4 bg-gradient-to-br from-pink-50 to-pink-100 rounded-xl min-w-max md:min-w-0 mx-0">
