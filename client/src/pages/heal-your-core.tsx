                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center space-x-3 flex-1 min-w-0">
                    ...
                    <div className="flex-1 min-w-0">
                      <p className="text-sm font-semibold text-green-800 truncate">
                        💙 Join our WhatsApp Community for extra support!
                      </p>
                      <p className="text-xs text-green-600 truncate">
                        Get guidance, motivation & celebrate wins with Zoe + coaches • ₹1000 for 3 months
                      </p>
                    </div>
                  </div>
                  <div className="flex items-center space-x-2 flex-shrink-0">
                    <Button
                      ...
                      className="bg-green-500 hover:bg-green-600 text-white px-4 py-2 text-xs font-semibold rounded-full shadow-md hover:shadow-lg transition-all duration-200 flex items-center space-x-1"
                    ...
                    <Button
                      ...
                      variant="ghost"
                      className="p-2 h-8 w-8 text-green-600 hover:text-green-800 hover:bg-green-100"
              ...
              <div className="flex items-start space-x-3">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-xs text-green-700 mb-3 leading-relaxed">
                    Join our exclusive WhatsApp community for guidance, motivation & celebrate wins with Zoe + coaches. Get the support you deserve!
                  </p>
                  <div className="flex items-center justify-between">
                    ...
                    <Button
                      ...
                      className="bg-green-500 hover:bg-green-600 text-white px-4 py-1.5 text-xs font-semibold rounded-full shadow-md hover:shadow-lg transition-all duration-200 flex items-center space-x-1"
