...
function ProgramsSection({ 
  ...
  return (
    <div className="space-y-6">
                ...
                <CardContent className="p-4">
                  ...
                  <div className="bg-pink-50 p-3 rounded-lg border-l-4 border-pink-400">
                    ...
                    <div className="space-y-1 text-xs text-gray-700">
                      <div className="flex items-start gap-2">
                        <span className="text-pink-600 font-bold">✧</span>
                        <span><span className="text-pink-600 font-semibold">Breathe First, Move Second:</span> Every movement begin with deep exhale and gentle core engagement.</span>
                      </div>
                      <div className="flex items-start gap-2">
                        <span className="text-pink-600 font-bold">✧</span>
                        <span><span className="text-pink-600 font-semibold">Feel, Don't Force:</span> The goal is to feel supported - not strained. If something feels off, pause, or regress.</span>
                      </div>
                      <div className="flex items-start gap-2">
                        <span className="text-pink-600 font-bold">✧</span>
                        <span><span className="text-pink-600 font-semibold">One Round Still Progress:</span> Don't skip a session just because you don't have time for all rounds.</span>
                      </div>
                      <div className="flex items-start gap-2">
                        <span className="text-pink-600 font-bold">✧</span>
                        <span><span className="text-pink-600 font-semibold">Doming, Heaviness, or Leaking?</span> Stop & regress to earlier exercises. That's your body's way of asking.</span>
                      </div>
                      <div className="flex items-start gap-2">
                        <span className="text-pink-600 font-bold">✧</span>
                        <span><span className="text-pink-600 font-semibold">Stay Consistent, Not Perfect:</span> Progress comes from showing up—even imperfectly.</span>
                      </div>
                      <div className="flex items-start gap-2">
                        <span className="text-pink-600 font-bold">✧</span>
                        <span><span className="text-pink-600 font-semibold">Hydrate, Rest, Nourish:</span> Give your body the care parts of your recovery too.</span>
                      </div>
                      <div className="flex items-start gap-2">
                        <span className="text-pink-600 font-bold">✧</span>
                        <span><span className="text-pink-600 font-semibold">Avoid Overexertion:</span> Stop immediately if you feel dizzy, nauseous, or overly fatigued.</span>
                      </div>
                      <div className="flex items-start gap-2">
                        <span className="text-pink-600 font-bold">✧</span>
                        <span><span className="text-pink-600 font-semibold">Consult Your Doctor:</span> Always consult with your healthcare provider before continuing with exercises.</span>
                      </div>
                    </div>
                  </div>
      ...
      {/* Space for additional programs */}
      <div className="text-center py-8 border-2 border-dashed border-gray-200 rounded-lg">
        <div className="text-gray-400">
          <h3 className="text-lg font-semibold mb-2">Add More Programs</h3>
          <p className="text-sm">Additional fitness programs can be added here</p>
        </div>
      </div>
