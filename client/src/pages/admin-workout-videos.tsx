      ...
      programs: [
        {
          ...
          days: [
            ...
            { day: 2, title: "Day 2: Glutes + Upper Body Burn", duration: "30-35 mins", exerciseIds: [], sections: [
              ...
              { name: "Finisher Flow", color: "bg-pink-100 text-pink-800 border-pink-300", exerciseIds: ['prenatal-mini-band-side-plank-clam', 'prenatal-standing-arm-rotations', 'prenatal-seated-90-90-glute-lift', 'prenatal-thread-the-needle'] },
            ...
            { day: 3, title: "Day 3: Functional Conditioning Circuit", duration: "30 mins", exerciseIds: [], sections: [
              ...
              { name: "Finisher Flow", color: "bg-pink-100 text-pink-800 border-pink-300", exerciseIds: ['prenatal-bird-dog-bodyweight', 'prenatal-core-compressions-wall-sits'] },
            ...
            { day: 4, title: "Day 4: Core + Shoulder Stability", duration: "25-30 mins", exerciseIds: [], sections: [
              ...
              { name: "Finisher Flow", color: "bg-pink-100 text-pink-800 border-pink-300", exerciseIds: ['prenatal-marching-band-wrist-pull', 'prenatal-side-plank-knee-leg-lifts', 'prenatal-all-fours-shoulder-taps'] },
            ...
            { day: 5, title: "Day 5: Strength + Mobility Reset", duration: "25-30 mins", exerciseIds: [], sections: [
              ...
              { name: "Finisher Flow", color: "bg-pink-100 text-pink-800 border-pink-300", exerciseIds: ['prenatal-knee-pushups', 'prenatal-bear-crawl-plank', 'prenatal-single-leg-stretch-reach', 'prenatal-pigeon-stretch', 'prenatal-seated-kneeling-core-compressions'] },
        ...
        },
        {
          ...
          days: [
            { day: 1, title: "Day 1: Full Body Burn + Core", duration: "30 mins", exerciseIds: [], sections: [
              ...
              { name: "Finisher Flow", color: "bg-pink-100 text-pink-800 border-pink-300", exerciseIds: ['prenatal-p2-seated-90-90-glute-stretch-rotation', 'prenatal-p2-modified-knee-elbow-opp', 'prenatal-p2-supine-core-compressions', 'prenatal-p2-all-fours-ball-pelvic-tilts'] },
            ...
            { day: 2, title: "Day 2: Glutes + Posture", duration: "30-35 mins", exerciseIds: [], sections: [
              ...
              { name: "Finisher Flow", color: "bg-pink-100 text-pink-800 border-pink-300", exerciseIds: ['prenatal-p2-band-glute-kickbacks-all-fours', 'prenatal-p2-wall-angels', 'prenatal-p2-childs-pose-open-palms-travel', 'prenatal-p2-seated-figure-8-rotations'] },
            ...
            { day: 3, title: "Day 3: Active Recovery Flow", duration: "25-30 mins", exerciseIds: [], sections: [
              ...
              { name: "Finisher Flow", color: "bg-pink-100 text-pink-800 border-pink-300", exerciseIds: ['prenatal-p2-side-plank-hip-lifts', 'prenatal-p2-cross-legged-twists', 'prenatal-p2-cross-legged-cross-hands-release', 'prenatal-p2-supine-core-compressions-belly-ribs'] },
            ...
            { day: 4, title: "Day 4: Functional Strength + Core", duration: "25-30 mins", exerciseIds: [], sections: [
              ...
              { name: "Finisher Flow", color: "bg-pink-100 text-pink-800 border-pink-300", exerciseIds: ['prenatal-p2-bird-dog-bodyweight-d4', 'prenatal-p2-sumo-squat-alternate-arm-lifts', 'prenatal-p2-bear-crawl-downward-dog-holds', 'prenatal-p2-all-fours-shoulder-taps'] },
        ...
        },
        {
          ...
          days: [
            { day: 1, title: "Day 1: Light Full Body Strength", duration: "25-30 mins", exerciseIds: [], sections: [
              ...
              { name: "Finisher Flow", color: "bg-pink-100 text-pink-800 border-pink-300", exerciseIds: ['prenatal-p3-standing-arm-rotations', 'prenatal-p3-cross-legged-twists', 'prenatal-p3-supine-core-compressions'] },
            ...
            { day: 2, title: "Day 2: Core + Glutes Connection", duration: "25 mins", exerciseIds: [], sections: [
              ...
              { name: "Finisher Flow", color: "bg-pink-100 text-pink-800 border-pink-300", exerciseIds: ['prenatal-p3-mini-band-elbow-side-plank-clams', 'prenatal-p3-seated-crossed-leg-glute-stretch', 'prenatal-p3-core-seated-chair-compressions', 'prenatal-p3-child-pose-single-leg-inner-thigh'] },
            ...
            { day: 3, title: "Day 3: Mobility Flow & Recovery", duration: "20-25 mins", exerciseIds: [], sections: [
              ...
              { name: "Finisher Flow", color: "bg-pink-100 text-pink-800 border-pink-300", exerciseIds: ['prenatal-p3-butterfly-elbow-rotations', 'prenatal-p3-supine-core-compressions-d3', 'prenatal-p3-cross-legged-cross-hands-release', 'prenatal-p3-chest-stretch-opener'] },
        ...
        },
        {
          ...
          days: [
            { day: 1, title: "Day 1: Soft Strength + Core Support", duration: "20-25 mins", exerciseIds: [], sections: [
              ...
              { name: "Finisher Flow", color: "bg-pink-100 text-pink-800 border-pink-300", exerciseIds: ['prenatal-p4-supine-pelvic-tilts', 'prenatal-p4-seated-90-90-glute-lift-reach', 'prenatal-p4-supine-core-compressions', 'prenatal-p4-child-pose-hips-lifted'] },
            ...
            { day: 2, title: "Day 2: Stretch + Breath Recovery Flow", duration: "20-25 mins", exerciseIds: [], sections: [
              ...
              { name: "Finisher Flow", color: "bg-pink-100 text-pink-800 border-pink-300", exerciseIds: ['prenatal-p4-squat-arm-rainbows', 'prenatal-p4-cross-legged-lat-stretch', 'prenatal-p4-supine-core-compressions-d2'] },
        ...
        },
        {
          ...
          days: [
            { day: 1, title: "Day 1: Build Your Own - Strength Focus", duration: "25-30 mins", exerciseIds: [], sections: [
              ...
              { name: "Finisher Flow", color: "bg-pink-100 text-pink-800 border-pink-300", exerciseIds: ['prenatal-p5-marching-band-wrist-pull-aparts', 'prenatal-p5-mini-band-elbow-side-plank-clams', 'prenatal-p5-band-squat-front-raise', 'prenatal-p5-db-bird-dog-rows', 'prenatal-p5-knee-pushups', 'prenatal-p5-squat-arm-rainbows'] },
            ...
            { day: 2, title: "Day 2: Core + Conditioning Mix", duration: "20-25 mins", exerciseIds: [], sections: [
              ...
              { name: "Finisher Flow", color: "bg-pink-100 text-pink-800 border-pink-300", exerciseIds: ['prenatal-p5-supine-core-compressions-d2', 'prenatal-p5-bird-dog', 'prenatal-p5-all-fours-ball-pelvic-tilts'] },
            ...
            { day: 3, title: "Day 3: Mix & Match Flow", duration: "20-25 mins", exerciseIds: [], sections: [
              ...
              { name: "Finisher Flow", color: "bg-pink-100 text-pink-800 border-pink-300", exerciseIds: ['prenatal-p5-side-lying-squeeze-shoulder-taps', 'prenatal-p5-supine-head-lifts-glute-bridge-reach'] },
              { name: "Beginner Option", color: "bg-green-100 text-green-800 border-green-300", exerciseIds: ['prenatal-p5-bird-dog-child-pose', 'prenatal-p5-supine-compressions-wall-sit-ball'] },
              { name: "Cooldown", color: "bg-cyan-100 text-cyan-800 border-cyan-300", exerciseIds: ['prenatal-cooldown'] }
            ]},
          ]
        },
