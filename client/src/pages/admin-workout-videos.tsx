      ...
      programs: [
        {
          ...
          days: [
            ...
            { day: 4, title: "Day 4: Core + Shoulder Stability", duration: "25-30 mins", exerciseIds: [], sections: [
              ...
              { name: "Beginner Option", color: "bg-green-100 text-green-800 border-green-300", exerciseIds: ['prenatal-bird-dog-bodyweight', 'prenatal-db-seated-shoulder-press', 'prenatal-db-seated-lateral-raises', 'prenatal-marching-band-wrist-pull', 'prenatal-knee-side-plank-leg-lift-hold'] },
              { name: "Finisher Flow", color: "bg-pink-100 text-pink-800 border-pink-300", exerciseIds: ['prenatal-sumo-squat-hold-twists', 'prenatal-all-fours-shoulder-taps', 'prenatal-seated-figure-8-arm-lifts'] },
              { name: "Cooldown", color: "bg-cyan-100 text-cyan-800 border-cyan-300", exerciseIds: ['prenatal-cooldown'] }
            ]},
            { day: 5, title: "Day 5: Strength + Mobility Reset", duration: "25-30 mins", exerciseIds: [], sections: [
              ...
              { name: "Beginner Option", color: "bg-green-100 text-green-800 border-green-300", exerciseIds: ['prenatal-bodyweight-reverse-lunges', 'prenatal-band-stiff-deadlifts', 'prenatal-side-lunges', 'prenatal-wall-supported-pushups', 'prenatal-bear-crawls-knee-lifts'] },
        ...
        },
        {
          ...
          days: [
            ...
            { day: 2, title: "Day 2: Glutes + Posture", duration: "30-35 mins", exerciseIds: [], sections: [
              { name: "Warmup", color: "bg-amber-100 text-amber-800 border-amber-300", exerciseIds: ['prenatal-warmup'] },
              { name: "Main Workout", color: "bg-purple-100 text-purple-800 border-purple-300", exerciseIds: ['prenatal-p2-glute-bridge-marches', 'prenatal-p2-kneeling-band-pull-aparts-block', 'prenatal-p2-dbs-alternating-lunges', 'prenatal-p2-band-seated-wide-row', 'prenatal-p2-band-glute-kickbacks-all-fours'] },
              ...
              { name: "Finisher Flow", color: "bg-pink-100 text-pink-800 border-pink-300", exerciseIds: ['prenatal-p2-wall-angels', 'prenatal-p2-childs-pose-open-palms-travel', 'prenatal-p2-seated-figure-8-rotations'] },
              { name: "Cooldown", color: "bg-cyan-100 text-cyan-800 border-cyan-300", exerciseIds: ['prenatal-cooldown'] }
            ]},
        ...
        },
        {
          ...
          days: [
            ...
            { day: 2, title: "Day 2: Core + Glutes Connection", duration: "25 mins", exerciseIds: [], sections: [
              { name: "Warmup", color: "bg-amber-100 text-amber-800 border-amber-300", exerciseIds: ['prenatal-warmup'] },
              { name: "Main Workout", color: "bg-purple-100 text-purple-800 border-purple-300", exerciseIds: ['prenatal-p3-wall-sit-with-ball', 'prenatal-p3-swiss-ball-seated-marches', 'prenatal-p3-banded-kneeling-fire-hydrants', 'prenatal-p3-side-plank-knee-rested-leg-lifts', 'prenatal-p3-mini-band-elbow-side-plank-clams'] },
              { name: "Beginner Option", color: "bg-green-100 text-green-800 border-green-300", exerciseIds: ['prenatal-p3-ball-squeeze-glute-bridges', 'prenatal-p3-seated-bent-knee-leg-lifts', 'prenatal-p3-kneeling-fire-hydrants', 'prenatal-p3-side-lying-straight-leg-lifts', 'prenatal-p3-mini-band-side-lying-clams-hold'] },
              { name: "Finisher Flow", color: "bg-pink-100 text-pink-800 border-pink-300", exerciseIds: ['prenatal-p3-seated-crossed-leg-glute-stretch', 'prenatal-p3-core-seated-chair-compressions', 'prenatal-p3-child-pose-single-leg-inner-thigh'] },
              { name: "Cooldown", color: "bg-cyan-100 text-cyan-800 border-cyan-300", exerciseIds: ['prenatal-cooldown'] }
            ]},
        ...
        },
        {
          ...
          days: [
            { day: 1, title: "Day 1: Soft Strength + Core Support", duration: "20-25 mins", exerciseIds: [], sections: [
              { name: "Warmup", color: "bg-amber-100 text-amber-800 border-amber-300", exerciseIds: ['prenatal-warmup'] },
              { name: "Main Workout", color: "bg-purple-100 text-purple-800 border-purple-300", exerciseIds: ['prenatal-p4-band-seated-narrow-rows', 'prenatal-p4-glute-bridges-mini-band', 'prenatal-p4-side-lying-leg-lifts-top-bent', 'prenatal-p4-seated-shoulder-db-press', 'prenatal-p4-supine-pelvic-tilts'] },
              ...
              { name: "Finisher Flow", color: "bg-pink-100 text-pink-800 border-pink-300", exerciseIds: ['prenatal-p4-seated-90-90-glute-lift-reach', 'prenatal-p4-supine-core-compressions', 'prenatal-p4-child-pose-hips-lifted'] },
              { name: "Cooldown", color: "bg-cyan-100 text-cyan-800 border-cyan-300", exerciseIds: ['prenatal-cooldown'] }
            ]},
        ...
        },
        {
          ...
          days: [
            { day: 1, title: "Day 1: Build Your Own - Strength Focus", duration: "25-30 mins", exerciseIds: [], sections: [
              ...
              { name: "Beginner Option", color: "bg-green-100 text-green-800 border-green-300", exerciseIds: ['prenatal-p5-band-squat-front-raise', 'prenatal-p5-db-bird-dog-rows', 'prenatal-p5-knee-pushups', 'prenatal-p5-squat-arm-rainbows', 'prenatal-p5-sumo-squat-bodyweight', 'prenatal-p5-seated-lateral-raises', 'prenatal-p5-kneeling-band-pull-aparts', 'prenatal-p5-mini-band-lying-clams-pulses'] },
              { name: "Finisher Flow", color: "bg-pink-100 text-pink-800 border-pink-300", exerciseIds: ['prenatal-p5-standing-arm-rotations', 'prenatal-p5-seated-same-side-leg-stretch-reach', 'prenatal-p5-supine-core-compressions'] },
              { name: "Cooldown", color: "bg-cyan-100 text-cyan-800 border-cyan-300", exerciseIds: ['prenatal-cooldown'] }
            ]},
            { day: 2, title: "Day 2: Core + Conditioning Mix", duration: "20-25 mins", exerciseIds: [], sections: [
              { name: "Warmup", color: "bg-amber-100 text-amber-800 border-amber-300", exerciseIds: ['prenatal-warmup'] },
              { name: "Option A: Strength & Core Flow", color: "bg-purple-100 text-purple-800 border-purple-300", exerciseIds: ['prenatal-p5-core-compressions-wall-sits', 'prenatal-p5-mini-band-glute-bridges', 'prenatal-p5-db-sumo-squat-rows'] },
              { name: "Option B: Core Reset", color: "bg-blue-100 text-blue-800 border-blue-300", exerciseIds: ['prenatal-p5-supine-core-compressions', 'prenatal-p5-bird-dog', 'prenatal-p5-all-fours-ball-pelvic-tilts'] },
              { name: "Option C: Stretch & Release", color: "bg-green-100 text-green-800 border-green-300", exerciseIds: ['prenatal-p5-cat-camel', 'prenatal-p5-same-side-leg-stretch-reach', 'prenatal-p5-child-pose-hips-lifted'] },
              { name: "Cooldown", color: "bg-cyan-100 text-cyan-800 border-cyan-300", exerciseIds: ['prenatal-cooldown'] }
            ]},
            { day: 3, title: "Day 3: Mix & Match Flow", duration: "20-25 mins", exerciseIds: [], sections: [
              { name: "Warmup", color: "bg-amber-100 text-amber-800 border-amber-300", exerciseIds: ['prenatal-warmup'] },
              { name: "Main Workout", color: "bg-purple-100 text-purple-800 border-purple-300", exerciseIds: ['prenatal-p5-cat-camel-thread-needle', 'prenatal-p5-seated-90-90-neck-rotations', 'prenatal-p5-side-lying-squeeze-shoulder-taps', 'prenatal-p5-supine-head-lifts-glute-bridge-reach', 'prenatal-p5-bird-dog-child-pose', 'prenatal-p5-supine-compressions-wall-sit-ball'] },
              { name: "Cooldown", color: "bg-cyan-100 text-cyan-800 border-cyan-300", exerciseIds: ['prenatal-cooldown'] }
            ]},
          ]
        },
