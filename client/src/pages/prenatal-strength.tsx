...
function PlayAllButton({ label = "PLAY ALL", className = "", url }: { label?: string; className?: string; url?: string }) {
  if (url) {
    return (
      <a 
        ...
        className={`inline-flex items-center justify-center gap-1 bg-blue-500 hover:bg-blue-600 text-white text-[10px] font-semibold px-2 py-1 rounded-full shadow-sm hover:shadow transition-all whitespace-nowrap ${className}`}
  ...
  return (
    <span 
      className={`inline-flex items-center justify-center gap-1 bg-gray-300 text-gray-500 text-[10px] font-semibold px-2 py-1 rounded-full whitespace-nowrap ${className}`}
      data-testid="button-play-all"
    >
                              ...
                              <table className="w-full text-sm">
                                ...
                                <tbody className="divide-y divide-purple-100">
                                  <tr>
                                    ...
                                    <td className="py-2 text-gray-600">10-12</td>
                                    <td className="py-2"><ExerciseLink name="Light DBs or Band" exercises={exercises} /></td>
                                  </tr>
                                  <tr>
                                    <td className="py-2 text-purple-600 font-medium">2</td>
                                    <td className="py-2"><ExerciseLink name="Single Leg Reverse Lunge to Knee Lift" exercises={exercises} /></td>
                                    <td className="py-2 text-gray-600">8-10/side</td>
                                    <td className="py-2"><ExerciseLink name="No Weights" exercises={exercises} /></td>
                                  </tr>
                                  <tr>
                                    <td className="py-2 text-purple-600 font-medium">3</td>
                                    <td className="py-2"><ExerciseLink name="Squat with Overhead Arm Reach" exercises={exercises} /></td>
                                    <td className="py-2 text-gray-600">10</td>
                                    <td className="py-2"><ExerciseLink name="Squat Seated on Chair" exercises={exercises} /></td>
                                  </tr>
                                  <tr>
                                    <td className="py-2 text-purple-600 font-medium">4</td>
                                    ...
                                    <td className="py-2"><ExerciseLink name="No Band" exercises={exercises} /></td>
                                  </tr>
                                  <tr>
                                    <td className="py-2 text-purple-600 font-medium">5</td>
                                    <td className="py-2"><ExerciseLink name="Seated 90 90 Glute Stretch with Rotation" exercises={exercises} /></td>
                                    <td className="py-2 text-gray-600">1 min</td>
                                    <td className="py-2"><ExerciseLink name="Same Exercise" exercises={exercises} /></td>
                                  </tr>
                                </tbody>
                              </table>
                            </div>
                              ...
                              <table className="w-full text-sm">
                                ...
                                <tbody className="divide-y divide-purple-100">
                                  <tr>
                                    ...
                                    <td className="py-2"><ExerciseLink name="Bear Crawl Pelvic Tilts" exercises={exercises} /></td>
                                  </tr>
                                  <tr>
                                    <td className="py-2 text-purple-600 font-medium">2</td>
                                    ...
                                    <td className="py-2"><ExerciseLink name="Kneeling Ball Squeeze / Core Lean Back" exercises={exercises} /></td>
                                  </tr>
                                  <tr>
                                    <td className="py-2 text-purple-600 font-medium">3</td>
                                    <td className="py-2"><ExerciseLink name="Bird Dog Bodyweight" exercises={exercises} /></td>
                                  ...
                                  <tr>
                                    ...
                                    <td className="py-2"><ExerciseLink name="Pillow Glute Bridges" exercises={exercises} /></td>
                                    <td className="py-2 text-gray-600">10</td>
                                    <td className="py-2"><ExerciseLink name="Supine Bodyweight Bridges" exercises={exercises} /></td>
                                  </tr>
                                  <tr>
                                    <td className="py-2 text-purple-600 font-medium">5</td>
                                    <td className="py-2"><ExerciseLink name="Side Plank Hip Lifts" exercises={exercises} /></td>
                                    <td className="py-2 text-gray-600">10/side</td>
                                    <td className="py-2"><ExerciseLink name="Side Lying Marches" exercises={exercises} /></td>
                                  </tr>
                                </tbody>
                              </table>
                            </div>
                              ...
                              <table className="w-full text-sm">
                                ...
                                <tbody className="divide-y divide-purple-100">
                                  <tr>
                                    ...
                                    <td className="py-2 text-gray-600">8-10/side</td>
                                    <td className="py-2"><ExerciseLink name="Band Lunge Lateral Raise" exercises={exercises} /></td>
                                  </tr>
                                  <tr>
                                    <td className="py-2 text-purple-600 font-medium">2</td>
                                    <td className="py-2"><ExerciseLink name="Supported Single Leg Glute Bridge Knee to Chest" exercises={exercises} /></td>
                                    <td className="py-2 text-gray-600">8-10/side</td>
                                    <td className="py-2"><ExerciseLink name="Glute Bridges on Bed or Chair" exercises={exercises} /></td>
                                  </tr>
                                  <tr>
                                    <td className="py-2 text-purple-600 font-medium">3</td>
                                    <td className="py-2"><ExerciseLink name="Band - Squat to Narrow Row" exercises={exercises} /></td>
                                    <td className="py-2 text-gray-600">10</td>
                                    <td className="py-2"><ExerciseLink name="Band Standing Wide to Narrow Row" exercises={exercises} /></td>
                                  </tr>
                                  <tr>
                                    <td className="py-2 text-purple-600 font-medium">4</td>
                                    <td className="py-2"><ExerciseLink name="DB Sumo Squat to Upright Row" exercises={exercises} /></td>
                                    <td className="py-2 text-gray-600">8/side</td>
                                    <td className="py-2"><ExerciseLink name="Keep Range Short" exercises={exercises} /></td>
                                  </tr>
                                  <tr>
                                    <td className="py-2 text-purple-600 font-medium">5</td>
                                    <td className="py-2"><ExerciseLink name="Bird Dog Bodyweight" exercises={exercises} /></td>
                                  ...
                                  <table className="w-full text-sm">
                                    ...
                                    <tbody className="divide-y divide-blue-100">
                                      ...
                                      <tr>
                                        ...
                                        <td className="py-2 text-gray-600">10/side</td>
                                        <td className="py-2"><ExerciseLink name="Glute Bridges" exercises={exercises} /></td>
                                      </tr>
                                      <tr>
                                        ...
                                        <td className="py-2 text-gray-600">10</td>
                                        <td className="py-2"><ExerciseLink name="Seated Arnold Press" exercises={exercises} /></td>
                                      </tr>
                                    </tbody>
                                  </table>
                                </div>
                                  ...
                                  <table className="w-full text-sm">
                                    ...
                                    <tbody className="divide-y divide-blue-100">
                                      <tr>
                                        ...
                                        <td className="py-2 text-gray-600">10</td>
                                        <td className="py-2"><ExerciseLink name="Ball Squeeze Glute Bridges" exercises={exercises} /></td>
                                      </tr>
                                      <tr>
                                        <td className="py-2 text-blue-600 font-medium">2</td>
                                        <td className="py-2"><ExerciseLink name="Swiss Ball Seated Marches" exercises={exercises} /></td>
                                        <td className="py-2 text-gray-600">10</td>
                                        <td className="py-2"><ExerciseLink name="Seated Bent Knee Leg Lifts" exercises={exercises} /></td>
                                      </tr>
                                      <tr>
                                        <td className="py-2 text-blue-600 font-medium">3</td>
                                        <td className="py-2"><ExerciseLink name="Banded Kneeling Fire Hydrants" exercises={exercises} /></td>
                                        <td className="py-2 text-gray-600">10/side</td>
                                        <td className="py-2"><ExerciseLink name="Kneeling Fire Hydrants" exercises={exercises} /></td>
                                      </tr>
                                      <tr>
                                        <td className="py-2 text-blue-600 font-medium">4</td>
                                        <td className="py-2"><ExerciseLink name="Side Plank with Knee Rested Leg Lifts" exercises={exercises} /></td>
                                      ...
                                      <tr>
                                        ...
                                        <td className="py-2"><ExerciseLink name="Mini Band Side Lying Clamshells" exercises={exercises} /></td>
                                      </tr>
                                    </tbody>
                                  </table>
                                </div>
                                  ...
                                  <table className="w-full text-sm">
                                    ...
                                    <tbody className="divide-y divide-blue-100">
                                      ...
                                      <tr>
                                        ...
                                        <td className="py-2"><ExerciseLink name="Seated Lean Back with Core Hold" exercises={exercises} /></td>
                                      </tr>
                                      <tr>
                                        <td className="py-2 text-blue-600 font-medium">3</td>
                                      ...
                                      <tr>
                                        ...
                                        <td className="py-2"><ExerciseLink name="Hands on Thighs for Support" exercises={exercises} /></td>
                                      </tr>
                                    </tbody>
                                  </table>
                                </div>
                                  ...
                                  <table className="w-full text-sm">
                                    ...
                                    <tbody className="divide-y divide-emerald-100">
                                      <tr>
                                        ...
                                        <td className="py-2"><ExerciseLink name="Band Standing Rows" exercises={exercises} /></td>
                                      </tr>
                                      <tr>
                                      ...
                                      <tr>
                                        ...
                                        <td className="py-2 text-gray-600">10/side</td>
                                        <td className="py-2"><ExerciseLink name="Side Lying Pillow Squeeze" exercises={exercises} /></td>
                                      </tr>
                                      <tr>
